package com.am.net {
	import com.am.utils.ObjectHelper;
	...
	public class Request {
		...
		public function Request(url:String, data:Object = null, method:String = 'GET', timeout:int = 80, weak:Boolean = true) {
		...
		public function send(url:String = null):void {
			if (url) this._request.url = url;
			try {
				...
				trace('Warning:', this.toString() + '.send();');
			}
		}
		...
		public function get json():Object {
			...
			if (this._data) {
				try {
					json = ObjectHelper.decode(String(this._data));
				} catch(event:Error) {
					json = new Object();
				}
			}
