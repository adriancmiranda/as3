package com.am.utils {
    ...
    public final class Browser {
        ...
        public static function mailTo(email:String, subject:String = '', body:String = '', cc:String = '', cco:String = ''):void {
            ...
            if (available) {
                if (appName == 'Microsoft Internet Explorer') {
                    sendToURL(new URLRequest('mailto:?Content-Type: text/plain;charset=UTF-8&body=Quem disse que não dá para usar%0Atecnologia pra falar de moda?%0AOlha só que demais esse desfile:%0Ahttps://www.youtube.com/pernambucanas'));
                } else {
                    gotoURL('mailto:' + email + '?Content-type=text/html&cc=' + cc + '&bcc' + cco + '&subject=' + subject + '&body=' + body, '_parent');
                }
            }
        }
        ...
        public static function get innerWidth():Number {
            return num(call('function(){return window.innerWidth;}'));
        }

        public static function get innerHeight():Number {
            return num(call('function(){return window.innerHeight;}'));
        }
