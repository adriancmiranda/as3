package com.am.display {
	...
	import com.am.core.IApplication;
	import com.am.core.File;
	import com.am.core.Language;
	import com.am.core.View;
	...
	public class SectionMax extends BaseMax implements ISection {
		...
		public function SectionMax(resizable:Boolean = true, autoStartRendering:Boolean = false, margin:Rectangle = null) {
