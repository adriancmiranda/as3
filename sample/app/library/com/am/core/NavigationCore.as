package com.am.core {
	...
	public class NavigationCore extends Dispatcher {
		...
		public function NavigationCore(key:String = null) {
			if (hasInstance(key)) throw new AMError(MULTITON_MESSAGE);
		...
		public function navigateTo(value:*, query:Object = null):void {
			if (value is String) {
				...
				value = BranchHelper.arrange(value);
		...
		public function getQueryString(path:String = null):String {
			return BranchHelper.getQueryString(path || Browser.href);
		}
